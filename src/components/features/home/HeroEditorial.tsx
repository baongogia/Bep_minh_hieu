        ...
        <div className="grid gap-10 py-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:gap-12 lg:py-14 xl:gap-16">
          <div className="relative flex flex-col justify-center">
            ...
            <div className="relative isolate mb-8">
              <span
                aria-hidden
                className="pointer-events-none absolute -left-2 -top-8 -z-10 select-none font-mono text-8xl font-extrabold text-stone-100/80 sm:text-9xl dark:text-stone-900/60"
              >
                01
              </span>
              ...
              <h1 className="relative space-y-2 font-sans">
                ...
                <span className="block font-sans text-4xl font-extrabold uppercase tracking-tight text-stone-950 md:text-5xl dark:text-stone-50">
                  Bếp công nghiệp
                </span>
                <span className="block font-sans text-2xl font-medium uppercase tracking-wide text-stone-600 md:text-3xl dark:text-stone-300">
                  Chính xác &amp; bền bỉ
                </span>
              </h1>
            </div>

            <p className="max-w-lg text-sm leading-7 text-stone-600 sm:text-base dark:text-stone-400">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/san-pham"
                className="inline-flex items-center rounded-md bg-stone-900 px-5 py-3 text-xs font-semibold uppercase tracking-wider text-stone-50 transition-colors hover:bg-stone-800 dark:bg-stone-100 dark:text-stone-900 dark:hover:bg-stone-200"
              >
                Xem danh mục thiết bị
              </Link>
              <Link
                href="/du-an"
                className="inline-flex items-center rounded-md border border-stone-300 bg-white px-5 py-3 text-xs font-semibold uppercase tracking-wider text-stone-900 transition-colors hover:border-stone-900 dark:border-stone-700 dark:bg-stone-900 dark:text-stone-100 dark:hover:border-stone-400"
              >
                Dự án đã thi công
              </Link>
            </div>

            <div className="mt-10 flex items-center gap-3 text-xs font-medium uppercase tracking-widest text-stone-500">
              <span>Next</span>
              <span className="text-stone-300">—</span>
              <span className="inline-flex items-center gap-1 text-stone-900 transition-colors hover:text-stone-600 dark:text-stone-200 dark:hover:text-stone-400">
                Preview
